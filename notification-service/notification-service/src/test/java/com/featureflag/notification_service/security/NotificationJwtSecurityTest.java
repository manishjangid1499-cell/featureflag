...
import com.featureflag.notification_service.controller.NotificationController;
...
@Import({SecurityConfig.class, NotificationJwtSecurityTest.TestJwtConfiguration.class})
class NotificationJwtSecurityTest {

    private static final String ISSUER = "feature-flag-auth";
    private static final String AUDIENCE = "feature-flag-api";
    private static final String EMAIL = "notification-user@company.com";
    ...
    @Test
    void allExistingReadPermissionsRemainUnchanged() throws Exception {
