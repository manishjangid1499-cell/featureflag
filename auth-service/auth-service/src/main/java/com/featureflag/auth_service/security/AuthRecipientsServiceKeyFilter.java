...
@Component
public class AuthRecipientsServiceKeyFilter extends OncePerRequestFilter {

    public static final String HEADER_NAME = "X-Auth-Recipients-Service-Key";
    public static final String AUTHORITY = "AUTH_RECIPIENTS_SERVICE";
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        return !RECIPIENTS_PATH.equals(request.getServletPath())
                && !RECIPIENTS_PATH.equals(request.getRequestURI());
    }
    ...
    protected void doFilterInternal(
        ...
        String providedServiceKey = request.getHeader(HEADER_NAME);
